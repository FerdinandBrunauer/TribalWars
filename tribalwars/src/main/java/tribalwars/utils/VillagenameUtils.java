...
public class VillagenameUtils {
	...
	public static void main(String[] args) {
		...
		name = generateVillagename(2, VillageTroupType.DEFF, true, true, false);
		System.out.println(name);
		name = generateVillagename(3, VillageTroupType.DEFF, true, true, false);
		System.out.println(name);
		name = generateVillagename(4, VillageTroupType.OFF, true, true, true);
		System.out.println(name);
		name = generateVillagename(5, VillageTroupType.DEFF, true, true, false);
		System.out.println(name);
		name = generateVillagename(6, VillageTroupType.OFF, true, true, true);
		System.out.println(name);
		name = generateVillagename(7, VillageTroupType.DEFF, true, true, false);
		System.out.println(name);
		name = generateVillagename(8, VillageTroupType.DEFF, true, true, false);
		System.out.println(name);
		...
		System.out.println(name);
		name = generateVillagename(11, VillageTroupType.OFF, true, true, true);
		System.out.println(name);
		name = generateVillagename(12, VillageTroupType.DEFF, true, true, false);
		System.out.println(name);
		name = generateVillagename(13, VillageTroupType.DEFF, true, true, false);
		System.out.println(name);
		name = generateVillagename(14, VillageTroupType.DEFF, true, true, false);
		System.out.println(name);
		name = generateVillagename(15, VillageTroupType.DEFF, true, true, false);
		System.out.println(name);
		name = generateVillagename(16, VillageTroupType.OFF, true, true, true);
		System.out.println(name);
	}
